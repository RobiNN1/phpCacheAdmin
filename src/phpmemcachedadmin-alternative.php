...
?>
    ...
    <section class="px-4 pt-20 pb-10 mx-auto max-w-7xl md:pt-32">
        ...
        <div class="overflow-hidden mt-16 mx-auto max-w-5xl rounded-lg border-2 border-gray-200 shadow-2xl md:rounded-2xl dark:border-white/10 dark:shadow-black/50">
            <img loading="lazy" class="w-full dark:hidden" src="assets/img/preview/memcached-light.webp" alt="phpCacheAdmin Memcached dashboard preview - light mode">
            <img loading="lazy" class="hidden w-full dark:block" src="assets/img/preview/memcached-dark.webp" alt="phpCacheAdmin Memcached dashboard preview - dark mode">
        </div>
    </section>
