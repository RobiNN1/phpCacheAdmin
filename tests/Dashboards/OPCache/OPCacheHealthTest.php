...
final class OPCacheHealthTest extends TestCase {
    ...
    public function testKeysCheck(): void {
    ...
    public function testInternedStringsCheck(): void {
    ...
    public function testJitCheck(): void {
    ...
    public function testWastedMemoryCheck(): void {
